...
let btn;
let counter = 0;
export function initContinueBtn() {
    btn = getElement("continue-btn");
...
function onClick() {
    ...
    if (counter <= 1000) {
        ...
        alert("i literally just told you i'm not doing anything anymore; ever considered touching some grass??");
    }
}
function getMsg(counter) {
    switch (true) {
        case counter < 2:
            return "baby steps";
        case counter < 50:
...
//# sourceMappingURL=continueBtn.js.map